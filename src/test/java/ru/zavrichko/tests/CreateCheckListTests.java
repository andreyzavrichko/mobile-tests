...
@Tag("selenide")
public class CreateCheckListTests extends TestBase {
    @Test
    ...
    void createNoteTest() {
        ...
        step("Type note", () ->
            $(AppiumBy.id("com.socialnmobile.dictapps.notepad.color.note:id/edit_note")).setValue("123456"));
    ...
    void createChecklistTest() {
        ...
        step("Add new item", () ->
                $(AppiumBy.id("com.socialnmobile.dictapps.notepad.color.note:id/text")).click());
        step("Add title", () ->
            $(AppiumBy.id("com.socialnmobile.dictapps.notepad.color.note:id/edit")).setValue("New item"));
        step("Tap button OK", () ->
